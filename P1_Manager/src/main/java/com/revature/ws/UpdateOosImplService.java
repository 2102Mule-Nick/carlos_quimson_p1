 ...
 * 2021-04-04T23:24:36.330-04:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "UpdateOosImplService",
                  wsdlLocation = "http://localhost:8080/P1_Maintenance/updateOos?wsdl",
...
public class UpdateOosImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/P1_Maintenance/updateOos?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UpdateOosImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/P1_Maintenance/updateOos?wsdl");
        }
        WSDL_LOCATION = url;
    }
