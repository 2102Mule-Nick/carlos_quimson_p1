...
public class AuthServiceImpl implements AuthService {
	...
	public Employee authenticateEmployee(Employee employee) {
		...
		// if employee is active and password is matched, return the employee object
		if ( (existingEmployee.getActive() != false) && (existingEmployee.getPassword().equals(employee.getPassword()))) {
